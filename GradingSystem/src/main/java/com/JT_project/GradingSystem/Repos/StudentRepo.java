...
public interface StudentRepo extends JpaRepository<Student,Long> {
	 ...
	 @Query(value="select s.first_name,s.second_name from students s,grades g,enroll e where s.student_id=g.belong_to_student and s.student_id=e.student_id and e.course_id=:course_id order by g.obtained_credit desc",nativeQuery = true)
