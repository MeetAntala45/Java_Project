...
//	
	...
	public List<String> show_grades(@PathVariable Long student_id)
	{
        ...
        {
        	result.add("Course : "+grade.getFor_course().getName()+"   "+"Grade : " +grade.getGrade_letter()+"   "+"Obtained Credit : "+grade.getObtained_credit()+"   "+"Internal Makrs : "+grade.getInternal_marks()+"   "+"External Makrs : "+grade.getExternal_marks()+"   "+"Practical Marks : "+grade.getPractical_marks()+"   ");
        }
        return result;
	...
	public String show_courseGrade(@PathVariable String course_name,@PathVariable Long student_id)
	{
        ...
        for (Grade grade : s.getGrades())
        {
        	...
        	{
        	     System.out.println(grade.getFor_course().getName());
        	     result="Grade : " +grade.getGrade_letter()+"\n"+"Obtained Credit : "+grade.getObtained_credit()+"\n"+"Internal Makrs : "+grade.getInternal_marks()+"\n"+"External Makrs : "+grade.getExternal_marks()+"\n"+"Practical Marks : "+grade.getPractical_marks()+"\n";
        	}
        }
        return result;
	}
